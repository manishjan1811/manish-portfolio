...
import { Code2, Database, Shield, Globe, Mail, MapPin, Calendar, ExternalLink, Award, Briefcase } from "lucide-react";
...
// About Section
export const AboutSectionOptimized = () => <SectionWrapper id="about" className="bg-muted/20">
    <SectionHeading title="About Me" description="Passionate cybersecurity professional dedicated to securing digital environments" />
    <div className="grid sm:grid-cols-2 gap-8 sm:gap-12 items-center">
      ...
      <div className="grid grid-cols-2 gap-3 sm:gap-4 order-1 sm:order-2">
        ...
        label: "Projects",
        value: "Multiple"
      }].map((item, index) => <Card key={index} className="p-3 sm:p-4 md:p-6 bg-card/50 border-border/50 hover:bg-card/70 transition-colors duration-200">
