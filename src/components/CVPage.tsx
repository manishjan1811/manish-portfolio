              ...
              <h2 className="text-xl md:text-2xl font-bold text-slate-800 mb-3 md:mb-4 border-b-2 border-blue-500 pb-2">
               ...
               <div className="grid grid-cols-2 gap-2">
                 <div className="p-2 bg-blue-50 rounded-lg text-center">
                   ...
                   <span className="text-xs font-medium text-slate-800">Making Websites using ai</span>
                 </div>
                 ...
                 <div className="p-2 bg-purple-50 rounded-lg text-center">
                   ...
                   <span className="text-xs font-medium text-slate-800 mx-[7px]">Automation Tools using ai</span>
                 </div>
                 <div className="p-2 bg-orange-50 rounded-lg text-center">
                   <Target className="w-5 h-5 md:w-6 md:h-6 text-orange-600 mx-auto mb-1" />
